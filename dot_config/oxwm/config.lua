...
oxwm.rule.add({ class = "Spotify", tag = 3 })  
...
oxwm.key.bind({}, "XF86AudioLowerVolume", oxwm.spawn("~/.local/bin/vol_control.sh down"))
oxwm.key.bind({}, "XF86AudioRaiseVolume", oxwm.spawn("~/.local/bin/vol_control.sh up"))
...
oxwm.autostart("picom --animations -b")                                  
oxwm.autostart("xwallpaper --zoom walls/deathstar.png") 
oxwm.autostart("dunst")
oxwm.autostart("xrander -s 2560x1440")
